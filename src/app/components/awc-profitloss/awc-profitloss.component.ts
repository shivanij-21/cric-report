...
@Component({
  selector: 'app-awc-profitloss',
  templateUrl: './awc-profitloss.component.html',
  styleUrls: ['./awc-profitloss.component.scss']
})
export class AwcProfitlossComponent implements OnInit {
  ...
  GetProfitLoss() {
    ...
    this.reportService.CasinoAWCProfitLoss(pnldates.fromdate, pnldates.todate).subscribe(
      (resp: any) => {
        if (this.stype == '') {
