...
@Component({
  selector: 'app-awc-bethistory',
  templateUrl: './awc-bethistory.component.html',
  styleUrls: ['./awc-bethistory.component.scss']
})
export class AwcBethistoryComponent implements OnInit {
  ...
  GetBetHistory() {
    ...
    this.reportService.casinoAWCBetsHistory(betdates.fromdate, betdates.todate, this.BETSTATUS).subscribe(
      (resp: any) => {
