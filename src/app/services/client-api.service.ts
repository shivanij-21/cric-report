...
export class ClientApiService {
  ...
  sendDispute(data: any) {
    return this.http.post(`https://social.cricbuzzer.io:15552/api/submitDispute`, data);
  }

  sendFeedback(data: any) {
    return this.http.post(`https://social.cricbuzzer.io:15552/api/submitFeedback`, data);
  }
  getlanguage() {
